      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 py-10 md:py-14">
          <div className="flex items-center gap-2 text-white/60 text-sm mb-4">
            ...
            <span className="text-white/80 font-medium">Ask Any Question</span>
          </div>
          <h1 className="font-display font-bold text-3xl md:text-4xl text-white mb-2 leading-tight">
            AI Study Assistant
          </h1>
          <p className="text-white/70 text-base max-w-2xl leading-relaxed">
            Ask any question from Physics, Chemistry, Biology, Maths, English,
            History, Geography, Economics — get instant detailed answers.
          </p>
        </div>
      </div>
