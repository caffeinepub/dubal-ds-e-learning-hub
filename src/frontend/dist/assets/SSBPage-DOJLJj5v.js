import { c as createLucideIcon, j as jsxRuntimeExports, S as Shield, B as BookOpen, r as reactExports } from "./index-CwPteKd5.js";
...
const SSB_DAYS = [
  ...
  // ── DAY 2 ────────────────────────────────────────────────────────────────
  {
    ...
    dayNotes: "Day 2 is the Psychology Test day. All four tests together take approximately 3-4 hours. These tests are designed to reveal your subconscious personality, values, and responses. Your responses are compared with your real behaviour (GTO and Interview). Consistency is key — be genuine throughout all tests. The psychologist is not looking for 'perfect' answers but for genuine Officer Like Qualities.",
    tasks: [
      {
        name: "TAT – Thematic Apperception Test",
        description: "Similar to PPDT but 11 pictures + 1 blank slide (12 total). Each picture is shown for 30 seconds. You write a story (4 minutes each) for the first 11 pictures, and for the blank slide you write any story of your choice. Total time: approximately 60 minutes. Pictures are hazy/unclear to allow interpretation. Stories reveal your personality, motivations, and values.",
      ...
      },
      {
        ...
        description: "60 situations are given in a booklet. Time: 30 minutes (30 seconds per situation). Each situation describes a real-life challenge/emergency. You write what you would do in that situation. Situations cover: natural disaster, accident, social injustice, group conflict, administrative challenge, moral dilemma.",
      ...
      },
      {
        ...
        description: "5 paragraphs to write about yourself as perceived by: (1) Your Parents, (2) Your Teachers, (3) Your Friends, (4) Yourself, (5) Your ideal self (who you want to become). Time: 15 minutes. Each paragraph: 3-5 sentences.",
  ...
  // ── DAYS 3–4 ─────────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description: "The group is given a model (physical layout of a disaster/emergency area) and a written narrative describing the problem. The group must plan a solution in 10 minutes, then give a group plan in 10-15 minutes. Individual plans are written first (5 min), then the group discusses and presents a common plan.",
      ...
      },
      {
        ...
        description: "Obstacle tasks done on a field using limited resources (wooden planks, ropes, barrel, balli/pole). The group must cross from point A to B without touching 'out-of-bounds' areas using only the given equipment. PGT: full group (10-12). HGT: half group (5-6). Both have 3-4 obstacles in a series.",
      ...
      },
      {
        ...
        description: "A series of 10 individual obstacles (Tarzan swing, Burma bridge, Jumping Ditch, Commando Net, Figure 8, Balancing Beam, etc.) with different point values (3, 2, 1). Time limit: 3 minutes. Attempt in any order you choose.",
      ...
      {
        name: "Command Task",
        description: "You are the commander. Select 2 of your group members as your subordinates. With their help, complete an obstacle (similar to PGT) in 10-15 minutes. GTO gives you a specific task — plan and execute.",
      ...
      {
        name: "Lecturette",
        description: "Individual task. Pick one of 4 topics (cards face-down). Prepare for 3 minutes. Deliver a 3-minute lecture/talk on the chosen topic to the group. Topics can be: social issues, current affairs, military/defence, general knowledge, abstract themes.",
      ...
      },
      {
        ...
        description: "Same as PGT but done at the end of all GTO activities. Full group again. GTO observes any changes in group dynamics and individual performance over the full 2 days.",
  ...
  // ── DAY 4 (IO Interview) ──────────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description: "The IO asks about: your life story, family background, education, why you want to join the forces, awareness of current affairs, knowledge about the arm you are applying for (Army/Navy/Air Force), your strengths and weaknesses, leadership experiences, hobbies and interests, failures and how you dealt with them.",
  ...
  // ── DAY 5 ────────────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description: "If recommended: you will appear for a medical board (3-5 days) to check physical and medical fitness. If medically fit and merit allows, you join the academy. If not recommended: you can attempt again (Army allows multiple attempts; Navy/AF have attempt limits). Use the feedback (if given) to improve.",
...
function OLQBadges() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: SSB_OVERVIEW.olqs.map((olq, i) => {
...
function TaskCard({ task, index }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-4 border-b border-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 mt-0.5 text-sm font-bold", children: index + 1 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-base text-foreground leading-snug", children: task.name }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: task.description }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground/80 leading-relaxed", children: task.tips })
            ]
          }
        )
      ]
...
function DayCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    AccordionItem,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-5 py-4 hover:no-underline hover:bg-secondary/30 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-left flex-1 mr-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold leading-none opacity-80", children: "Day" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold leading-none", children: day.day })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base text-foreground leading-snug", children: day.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: day.subtitle })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Badge,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionContent, { className: "px-5 pb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: day.dayNotes
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: day.tasks.map((task, ti) => /* @__PURE__ */ jsxRuntimeExports.jsx(TaskCard, { task, index: ti }, task.name)) })
        ] })
      ]
    }
  );
...
function SSBQATab() {
  ...
  const [activeSection, setActiveSection] = reactExports.useState("All");
  const filtered = activeSection === "All" ? SSB_QA : SSB_QA.filter((q) => q.section === activeSection);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3", children: "Filter by Section" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "flex flex-wrap gap-2",
          "data-ocid": "ssb.qabank.section.filter",
          children: ["All", ...sections].map((sec) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "multiple", className: "space-y-3", children: filtered.map((entry, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      AccordionItem,
      {
        value: `ssb-qa-${idx}`,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-5 py-4 hover:no-underline hover:bg-secondary/40 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 text-left flex-1 mr-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-3.5 h-3.5" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground leading-snug", children: entry.q }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "outline",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-5 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-2 pl-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: entry.a })
            }
          ) }) })
        ]
      },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: "linear-gradient(135deg, oklch(0.15 0.08 264) 0%, oklch(0.24 0.14 264) 60%, oklch(0.20 0.10 280) 100%)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "radial-gradient(circle at 15% 70%, oklch(0.65 0.18 264) 0%, transparent 40%), radial-gradient(circle at 90% 20%, oklch(0.75 0.15 52) 0%, transparent 35%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-8 right-8 opacity-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: ["s1", "s2", "s3", "s4", "s5"].map((id, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Star,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 container mx-auto px-4 py-12 md:py-16", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-white/60 text-sm mb-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Indian Armed Forces Officer Selection" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-3xl md:text-5xl text-white mb-3 leading-tight", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: {
                    backgroundImage: "linear-gradient(90deg, oklch(0.80 0.15 52), oklch(0.85 0.18 52))"
                  },
                  children: "Board (SSB)"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/75 text-base md:text-lg max-w-2xl leading-relaxed mb-6", children: "5-Day Officer Selection Process for Indian Army, Navy & Air Force — covering Screening Tests, Psychology (TAT/WAT/SRT/SD), GTO Tasks, Personal Interview, and Conference." }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(135deg, oklch(0.15 0.08 264 / 0.08) 0%, oklch(0.24 0.14 264 / 0.05) 100%)"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-lg text-foreground", children: "What is SSB?" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 space-y-4 bg-card", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: SSB_OVERVIEW.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-3.5 rounded-xl bg-secondary/50 border border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleCheckBig,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground mb-0.5", children: "Eligibility" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground", children: SSB_OVERVIEW.eligibility })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "Officer Like Qualities (OLQs) — 15 qualities assessed" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(OLQBadges, {})
              ] })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "process", className: "w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsList,
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TabsTrigger,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "5-Day Process" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TabsTrigger,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-4 h-4 flex-shrink-0" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "process", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground", children: "The 5-Day SSB Process" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Accordion,
            {
              ...
              children: SSB_DAYS.map((day, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(DayCard, { day, index: i }, day.day))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "qabank", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground", children: "SSB Q&A Bank" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SSBQATab, {})
        ] })
      ] })
    ] })
  ] });
