import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as BrainCircuit, f as Skeleton, Z as Zap, C as Category } from "./index-CwPteKd5.js";
...
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-C6Rpj1KK.js";
import { Q as QA_BANK } from "./useQueries-Wt3to53f.js";
import { s as searchTopics } from "./topicAnswers-pqUazWLI.js";
import { T as Textarea } from "./textarea-Cfdu0A3b.js";
import { X } from "./x-BxTPOHde.js";
import { R as RefreshCw } from "./refresh-cw-AWmzvHD5.js";
import { S as Sparkles } from "./sparkles-Be7Gqazk.js";
import { C as Check } from "./check-Dx36GMjV.js";
import { C as Copy } from "./copy-BAYf5Bxg.js";
import { C as ChevronRight } from "./chevron-right-DDHxRzLp.js";
import { S as Search } from "./search-D7yVhnDR.js";
import { L as Lightbulb } from "./lightbulb-DBNizhYg.js";
...
const MicOff = createLucideIcon("mic-off", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function useVoiceInput(onResult, onAutoSend) {
  ...
  const onAutoSendRef = reactExports.useRef(onAutoSend);
  onResultRef.current = onResult;
  onAutoSendRef.current = onAutoSend;
  reactExports.useEffect(() => {
    const SpeechRecognitionAPI = getSpeechRecognition$1();
    if (SpeechRecognitionAPI) {
      ...
      rec.onresult = (event) => {
        ...
        if (onAutoSendRef.current && transcript.trim()) {
          setTimeout(() => {
            var _a;
            return (_a = onAutoSendRef.current) == null ? void 0 : _a.call(onAutoSendRef, transcript.trim());
          }, 200);
        }
      };
...
const SYSTEM_PROMPT = "You are an expert education assistant for Indian students studying CBSE Class 10, Class 12, JEE, NEET, and competitive exams (UPSC, SSC, Bank PO, NDA, SSB). Answer any question clearly and thoroughly. For math and science, use step-by-step examples. You can also answer general knowledge, current affairs, history, geography, English grammar, and any other topic a student may ask. Keep answers detailed but easy to understand.";
...
const AI_AVATAR_SRC = "/assets/uploads/Screenshot_2026-02-22-23-49-52-28_6012fa4d4ddec268fc5c7112cbb265e7-2-1.jpg";
function TypingIndicator() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full overflow-hidden flex-shrink-0 shadow-md ring-2 ring-indigo-400/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: AI_AVATAR_SRC,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-2xl rounded-bl-sm px-4 py-3 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5 h-5", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
...
function MessageBubble({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        isUser ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center flex-shrink-0 shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-4 h-4 text-white" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full overflow-hidden flex-shrink-0 shadow-md ring-2 ring-indigo-400/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: AI_AVATAR_SRC,
            alt: "डुबल डी एस सेवा केंद्र",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              message.isError ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              ) : isUser ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-indigo-600 to-violet-600 text-white rounded-2xl rounded-br-sm px-4 py-3 text-sm leading-relaxed shadow-md", children: displayContent }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-2xl rounded-bl-sm px-4 py-3 text-sm leading-relaxed shadow-sm text-foreground whitespace-pre-wrap", children: displayContent }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `flex items-center gap-2 px-1 ${isUser ? "flex-row-reverse" : "flex-row"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: formatTime(message.timestamp) }),
                    !isUser && !message.isError && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          className: `transition-colors p-0.5 rounded ${isSpeaking ? "text-indigo-500 hover:text-destructive" : "text-muted-foreground hover:text-indigo-500"}`,
                          ...
                          children: isSpeaking ? /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "w-3 h-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "w-3 h-3" })
                        }
                      )
                    ] })
                  ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground mb-1", children: "डुबल डी एस सेवा केंद्र मे आपका स्वागत है" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-6 max-w-xs leading-relaxed", children: [
          "कोई भी सवाल पूछें — पढ़ाई, परीक्षा, सामान्य ज्ञान, या कुछ भी।",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs opacity-70", children: "Ask anything in English or Hindi" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs opacity-50 italic flex items-center justify-center gap-1 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "w-3 h-3 inline-block" }),
            "Voice greeting plays on first visit"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-indigo-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-600", children: "Powered by Advanced AI" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3", children: "Try these questions" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center max-w-lg", children: STARTER_QUESTIONS.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function useWelcomeGreeting(onPlay) {
  const onPlayRef = reactExports.useRef(onPlay);
...
function WelcomeBanner({ visible }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: visible && /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      "aria-live": "polite",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-end gap-0.5", children: [
          { h: 1, delay: 0 },
          { h: 2, delay: 0.1 },
          { h: 3, delay: 0.2 },
          { h: 2, delay: 0.3 },
          { h: 1, delay: 0.4 }
        ].map(({ h, delay: delay2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
...
function AIChatTab() {
  ...
  const [voiceReplyEnabled, setVoiceReplyEnabled] = reactExports.useState(false);
  ...
  const [showWelcomeBanner, setShowWelcomeBanner] = reactExports.useState(false);
  ...
  useWelcomeGreeting(() => {
    ...
    setTimeout(() => setShowWelcomeBanner(false), 4e3);
  });
  const handleVoiceResult = reactExports.useCallback((text) => {
  ...
  const { isListening, isSupported, startListening, stopListening } = useVoiceInput(handleVoiceResult, (text) => sendMessageRef.current(text));
  ...
  const speakText = reactExports.useCallback(
    (id2, text) => {
...
Describe or analyze this image.`
      ...
      reader2.onerror = () => setFileError("Failed to read image.");
    ...
    if (ext === "txt" || file.type === "text/plain") {
      ...
      reader.onload = (e) => {
        var _a2;
        const buffer = (_a2 = e.target) == null ? void 0 : _a2.result;
        const extracted = extractTextFromArrayBuffer(buffer);
        setAttachedFile({
          name: file.name,
          text: extracted.length > 50 ? extracted : `(Could not extract readable text from ${file.name}. It may be image-based or a binary format.)`
        });
      };
  ...
  const sendMessage = reactExports.useCallback(
    async (text) => {
      ...
      const displayText = attachedFile ? `📎 ${attachedFile.name} attached

${trimmed}` : trimmed;
      const apiText = attachedFile ? `Document: ${attachedFile.name}
...
User question: ${trimmed}` : trimmed;
  ...
  const [plusMenuOpen, setPlusMenuOpen] = reactExports.useState(false);
  const plusMenuRef = reactExports.useRef(null);
  const plusButtonRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    if (!plusMenuOpen) return;
    const handleClickOutside = (e) => {
      if (plusMenuRef.current && !plusMenuRef.current.contains(e.target) && plusButtonRef.current && !plusButtonRef.current.contains(e.target)) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(WelcomeBanner, { visible: showWelcomeBanner }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border bg-card/50 backdrop-blur-sm flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full overflow-hidden flex-shrink-0 shadow-md ring-2 ring-indigo-400/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: AI_AVATAR_SRC,
            alt: "डुबल डी एस सेवा केंद्र",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground leading-tight", children: "डुबल डी एस सेवा केंद्र" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-green-500 font-medium leading-tight flex items-center gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            className: `gap-1.5 h-8 px-3 text-xs font-semibold transition-all duration-200 rounded-lg border ${voiceReplyEnabled ? "bg-gradient-to-r from-green-600 to-emerald-600 text-white border-green-500 hover:from-green-500 hover:to-emerald-500 shadow-sm shadow-green-500/30" : "text-muted-foreground border-border hover:text-foreground hover:border-foreground/30"}`,
            "data-ocid": "aihelp.voice.toggle",
            "aria-label": voiceReplyEnabled ? "Disable voice reply" : "Enable voice reply",
            title: voiceReplyEnabled ? "Voice reply ON — click to mute" : "Enable AI voice reply",
            children: voiceReplyEnabled ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative flex h-2 w-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-ping absolute inline-flex h-full w-full rounded-full bg-white opacity-60" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Voice" })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "w-3.5 h-3.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Mute" })
            ] })
          }
        ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-4 py-4 min-h-0", children: messages.length === 0 && !isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { onSuggestionClick: (q) => sendMessage(q) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: messages.map((msg, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        MessageBubble,
        {
          message: msg,
          index: idx,
      ...
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(TypingIndicator, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pb-3 pt-1 flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: fileError && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          className: "mb-2",
          "data-ocid": "aihelp.chat.error_state",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2 rounded-xl bg-destructive/10 border border-destructive/30 text-destructive text-xs font-medium", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-3.5 h-3.5 flex-shrink-0" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card shadow-lg overflow-visible", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: attachedFile && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-sm font-medium max-w-full mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", children: "📎" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate max-w-[180px] text-xs text-indigo-700 dark:text-indigo-300", children: attachedFile.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "· up to 50 MB ✓" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Textarea,
          {
            ...
            placeholder: isListening ? "🎙 Listening… speak now" : "Ask any question… (Enter to send, Shift+Enter for new line)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2 relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                disabled: isLoading,
                className: `w-9 h-9 rounded-full flex items-center justify-center shadow-md transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${plusMenuOpen ? "bg-gradient-to-br from-indigo-500 to-violet-600 text-white shadow-indigo-500/30" : "bg-gradient-to-br from-slate-600 to-slate-700 text-white hover:from-slate-500 hover:to-slate-600"} disabled:opacity-50 disabled:cursor-not-allowed`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: plusMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ref: plusMenuRef,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-9 h-9 rounded-full bg-indigo-500/10 flex items-center justify-center flex-shrink-0 group-hover:bg-indigo-500/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Paperclip, { className: "w-4 h-4 text-indigo-600 dark:text-indigo-400" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground leading-tight", children: "Upload File" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "PDF, TXT, JPEG, PNG & more · up to 50 MB" })
                        ] })
                      ]
                    }
                  ),
                    ...
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            className: `w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 transition-colors ${voiceReplyEnabled ? "bg-green-500/15 group-hover:bg-green-500/25" : "bg-muted group-hover:bg-muted/80"}`,
                            children: voiceReplyEnabled ? /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "w-4 h-4 text-green-600 dark:text-green-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "w-4 h-4 text-muted-foreground" })
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground leading-tight", children: "Voice Reply" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: voiceReplyEnabled ? "AI reads replies aloud" : "Replies are silent" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "span",
                          {
                            className: `flex items-center gap-1 text-xs font-semibold px-2 py-0.5 rounded-full flex-shrink-0 ${voiceReplyEnabled ? "bg-green-500/15 text-green-700 dark:text-green-400" : "bg-muted text-muted-foreground"}`,
                            children: [
                              voiceReplyEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-green-500 inline-block" }),
          ...
          isSupported && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              disabled: isLoading,
              className: `w-9 h-9 rounded-full flex items-center justify-center shadow-md transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed ${isListening ? "bg-gradient-to-br from-red-500 to-rose-600 text-white shadow-red-500/40 animate-pulse" : "bg-gradient-to-br from-emerald-500 to-green-600 text-white hover:from-emerald-400 hover:to-green-500 shadow-emerald-500/30"}`,
              "aria-label": isListening ? "Stop voice input" : "Start voice input",
              title: isListening ? "Stop — AI will reply automatically" : "Speak your question (auto-sends when done)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isListening && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.span,
            {
          ...
          inputValue.length > MAX_CHARS * 0.75 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `text-xs tabular-nums mr-1 ${charsLeft < 50 ? "text-destructive font-semibold" : "text-muted-foreground/70"}`,
              children: charsLeft
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "w-4 h-4 text-white animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "w-4 h-4 text-white" })
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60 mt-1.5 text-center", children: "🎙 Voice auto-sends · + to upload files · Enter to send" })
    ] })
  ] });
}
...
const QA_KEYWORDS_CACHE = {};
function getQAKeywords(question) {
...
function searchQABankDirect(query) {
  ...
  const match = QA_BANK.find((entry) => {
    ...
    const matchCount = queryWords.filter(
      (qw) => entryWords.some((ew) => ew.includes(qw) || qw.includes(ew))
    ).length;
    return matchCount >= Math.min(2, queryWords.length);
  });
  return match ?? null;
}
function TopicSmartNoteResult({ result }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-primary/10 text-primary flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-5 h-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground leading-snug", children: result.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs font-medium", children: result.subject }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs font-medium", children: result.category })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-background rounded-xl p-5 border border-border shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed whitespace-pre-line", children: result.answer }) })
      ]
    }
  );
}
function QuickSearchTab({
  ...
  const [topicResult, setTopicResult] = reactExports.useState(null);
  ...
  const askInputRef = reactExports.useRef(null);
  const handleVoiceResult = reactExports.useCallback((text) => {
    setAskInput(text);
    setTimeout(() => {
      runSearch(text);
  ...
  const handleClear = () => {
    ...
    setHasSearched(false);
    setIsThinking(false);
    (_a = askInputRef.current) == null ? void 0 : _a.focus();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 p-5 bg-card rounded-2xl border border-border shadow-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-3 font-medium", children: "Search from our knowledge base — Physics, Chemistry, Biology, Maths, English, History, Geography, Economics..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              placeholder: isListening ? "Listening… speak now" : "e.g. What is Newton's second law? Explain photosynthesis...",
        ...
        isSupported && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            className: `h-12 w-12 p-0 flex-shrink-0 transition-all duration-200 ${isListening ? "bg-red-500 hover:bg-red-400 animate-pulse border-0" : "bg-gradient-to-br from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 border-0"}`,
            "data-ocid": "aihelp.askai.voice_button",
            "aria-label": isListening ? "Stop voice search" : "Voice search",
            title: isListening ? "Stop listening" : "Speak your question",
            children: isListening ? /* @__PURE__ */ jsxRuntimeExports.jsx(MicOff, { className: "w-5 h-5 text-white" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "w-5 h-5 text-white" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: isThinking ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    isThinking && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-1/2 mb-2" }),
    ...
    !isThinking && topicResult && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "aihelp.askai.result", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
          "Answer for:",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: askInput })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TopicSmartNoteResult, { result: topicResult })
    ] }),
    !isThinking && qaResult && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "aihelp.askai.result", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
          "Answer for:",
          " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-background to-accent/5 p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-accent/20 text-accent-foreground flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "w-5 h-5 text-accent" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground leading-snug", children: qaResult.question }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  ...
                  children: qaResult.category
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: qaResult.subject })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-background rounded-xl p-5 border border-border shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed whitespace-pre-line", children: qaResult.answer }) })
      ] })
    ] }),
    !isThinking && notFound && hasSearched && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        "data-ocid": "aihelp.askai.empty_state",
        className: "flex flex-col items-center gap-4 py-12 text-center",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-secondary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrainCircuit, { className: "w-8 h-8 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-lg text-foreground", children: "No Result in Quick Search" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm mt-1 max-w-sm", children: [
              "Try the ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "AI Chat" }),
              " tab for any question — it uses real AI and can answer anything. Or try one of these topics:"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center max-w-md", children: suggestedTopics.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    !isThinking && !topicResult && !qaResult && !notFound && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3", children: "Example questions — click to search" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2 mb-8", children: askAIExamples.map((example) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-1.5 text-primary/70 group-hover:text-primary", children: "→" }),
            example
          ]
        },
        example
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4", children: [
        {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm mb-1.5 text-foreground", children: t.title }),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "radial-gradient(circle at 80% 50%, oklch(0.75 0.18 52) 0%, transparent 50%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 container mx-auto px-4 py-8 md:py-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-white/60 text-sm mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(BrainCircuit, { className: "w-4 h-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "AI Help" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/80 font-medium", children: "Ask Anything · Powered by AI" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-3xl md:text-4xl text-white mb-2 leading-tight", children: "AI Study Assistant — Ask Anything" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-base max-w-2xl leading-relaxed", children: "Powered by advanced AI — ask any question about Physics, Chemistry, Biology, Maths, English, History, Geography, competitive exams, or anything else. Get instant, detailed answers." })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col container mx-auto px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "aichat", className: "flex flex-col flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid grid-cols-2 w-full max-w-sm mb-6 bg-secondary/60 p-1 rounded-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
            value: "aichat",
        ...
        TabsContent,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(AIChatTab, {})
            }
          )
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "quicksearch", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        QuickSearchTab,
        {
          activeCategory,
          onCategoryChange
